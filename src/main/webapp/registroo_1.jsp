    ...
    <body>
        ...
        <main>
            <div class="center-small">
                <h1 class="form_title">PAGINA 1</h1>
                <%
                        ...
                        out.println("<br> Nombre1: \t" + sesion.getAttribute("nombre"));
                        out.println("<br> Apellido1: \t" + sesion.getAttribute("apellido"));
                        out.println("<br> Correo1: \t" + sesion.getAttribute("correo"));
